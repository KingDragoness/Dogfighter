...
namespace MFlight
{
    ...
    public class MouseFlightController : MonoBehaviour
    {
        ...
        public static MouseFlightController instance;
        ...
        private void RotateRig()
        {
            ...
            if (Input.GetButtonDown("MouseAim"))
            {
                isMouseAimFrozen = false;
                mouseAim.forward = frozenDirection;
            }
            else if (Input.GetButtonUp("MouseAim"))
            {
            ...
            float gamepadLookX = 0;// Input.GetAxis("Look X") * mouseSensitivity;
            float gamepadLookY = 0; //-Input.GetAxis("Look Y") * mouseSensitivity;

            totalLookAxisUp = gamepadLookY + mouseLookAxisUp;
            totalLookAxisRight = gamepadLookX + mouseLookAxisRight;
            ...
            mouseAim.Rotate(cam.right, totalLookAxisUp, Space.World);
            mouseAim.Rotate(cam.up, totalLookAxisRight, Space.World);
